        ...
        <>
            <div className='bg-black h-auto pb-5'>
                ...
                <div className='flex justify-end mr-10 flex-row'>
                    <h1 className='text-yellow-400 mr-10 mt-[-6%] font-bold flex-wrap text-2xl max-sm:mr-[-30px] max-sm:mt-[-35px]  max-md:mr-[10px] max-md:mt-[-40px] max max-lg:mr-[10px] max-xl:mt-[-40px] '><AccountCircleIcon fontSize='large' /> {username}</h1>
                </div>
            ...
            <div className='flex justify-center bg-red-700 pt-10'>
                <div className="card bg-white w-[60%] text-black mb-10">
                    ...
                    <DataTable className='text-xl ml-5 mb-5' value={listUsuarios}
                        showGridlines
                        stripedRows
                        size='small'
